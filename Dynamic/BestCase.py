...
# Calculate and display the best-case distance and total execution time
best_case_distance_dynamic = total_distance / num_runs
print(f"Best Case Distance for Dynamic Programming with {num_cities} cities over {num_runs} runs: {best_case_distance_dynamic}")
