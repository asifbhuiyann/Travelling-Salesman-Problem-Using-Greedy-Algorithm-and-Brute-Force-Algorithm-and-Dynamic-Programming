...
def tsp_greedy_best_case(distances):
    ...
    # Generate a best-case scenario where the nearest unvisited city is always the next city.
    for _ in range(n - 1):
...
# Generate random distances and calculate the execution time for the best-case scenario
...
# Print the result including the best-case distance and total execution time
